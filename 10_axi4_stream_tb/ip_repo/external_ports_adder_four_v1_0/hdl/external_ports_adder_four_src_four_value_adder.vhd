-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLAXI4Stream/external_ports_adder_four_src_four_value_adder.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: external_ports_adder_four_src_four_value_adder
...
USE work.external_ports_adder_four_src_four_value_adder_pac.ALL;

ENTITY external_ports_adder_four_src_four_value_adder IS
...
END external_ports_adder_four_src_four_value_adder;


ARCHITECTURE rtl OF external_ports_adder_four_src_four_value_adder IS

  -- Component Declarations
  COMPONENT external_ports_adder_four_src_rising_edge
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
  ...
  FOR ALL : external_ports_adder_four_src_rising_edge
    USE ENTITY work.external_ports_adder_four_src_rising_edge(rtl);
...
BEGIN
  u_rising_edge : external_ports_adder_four_src_rising_edge
    PORT MAP( clk => clk,
              reset_x => reset_x,
  ...
  Switch1_out1 <= Unit_Delay_out1 WHEN AND_out1 = '0' ELSE
      Delay6_out1;
