-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLAXI4Stream/axi4_stream_adder_four_fifo_data.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: axi4_stream_adder_four_fifo_data
-- Source Path: axi4_stream_adder_four/axi4_stream_adder_four_axi4_stream_slave/axi4_stream_adder_four_fifo_data
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY axi4_stream_adder_four_fifo_data IS
...
END axi4_stream_adder_four_fifo_data;


ARCHITECTURE rtl OF axi4_stream_adder_four_fifo_data IS

  -- Component Declarations
  COMPONENT axi4_stream_adder_four_SimpleDualPortRAM_generic
  ...
  FOR ALL : axi4_stream_adder_four_SimpleDualPortRAM_generic
    USE ENTITY work.axi4_stream_adder_four_SimpleDualPortRAM_generic(rtl);
  ...
  SIGNAL w_waddr_unsigned                 : unsigned(7 DOWNTO 0);  -- ufix8
  SIGNAL w_d2                             : unsigned(7 DOWNTO 0);  -- ufix8
  SIGNAL w_out                            : unsigned(7 DOWNTO 0);  -- ufix8
  SIGNAL cache_data                       : unsigned(7 DOWNTO 0);  -- ufix8
  SIGNAL data_out_next                    : unsigned(7 DOWNTO 0);  -- ufix8
  SIGNAL Out_tmp                          : unsigned(7 DOWNTO 0);  -- ufix8

BEGIN
  -- us1: Upsample by 1, Sample offset 0 
  u_axi4_stream_adder_four_fifo_data_classic_ram_generic : axi4_stream_adder_four_SimpleDualPortRAM_generic
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset_x = '1' THEN
        cache_data <= to_unsigned(16#00#, 8);
