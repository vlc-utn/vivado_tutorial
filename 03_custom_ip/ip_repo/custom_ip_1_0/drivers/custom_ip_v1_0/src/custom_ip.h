 ...
 *
 * @param   BaseAddress is the base address of the CUSTOM_IPdevice.
 ...
 * @note
 * C-style signature:
 * 	void CUSTOM_IP_mWriteReg(u32 BaseAddress, unsigned RegOffset, u32 Data)
 *
 */
 ...
 * @note
 * C-style signature:
 * 	u32 CUSTOM_IP_mReadReg(u32 BaseAddress, unsigned RegOffset)
 *
 */
