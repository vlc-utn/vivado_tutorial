-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/hdl_block/Sin_cordic_nw.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Sin_cordic_nw
-- Source Path: hdl_block/my_block/Sin_cordic_nw
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF Sin_cordic_nw IS
  ...
  SIGNAL y_temp_0_1_1                     : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL y_temp_1_1_1                     : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL y1                               : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL y1_p                             : signed(15 DOWNTO 0) := to_signed(16#0000#, 16);  -- sfix16_En14
  SIGNAL y_p_negate_cast                  : signed(16 DOWNTO 0);  -- sfix17_En14
  SIGNAL y_p_negate_cast_1                : signed(16 DOWNTO 0);  -- sfix17_En14
  SIGNAL y_p_negate_1                     : signed(15 DOWNTO 0);  -- sfix16_En14
  SIGNAL sin_tmp                          : signed(15 DOWNTO 0);  -- sfix16_En14
...
BEGIN
  ...
  y1 <= y_temp_0_1_1 WHEN switch_compare_1_9 = '0' ELSE
      y_temp_1_1_1;
  ...
  y_p_negate_cast <= resize(y1_p, 17);
  y_p_negate_cast_1 <=  - (y_p_negate_cast);
  y_p_negate_1 <= y_p_negate_cast_1(15 DOWNTO 0);

  
  sin_tmp <= y1_p WHEN switch_compare_1_4 = '0' ELSE
      y_p_negate_1;
