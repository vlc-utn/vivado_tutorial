-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/hdlcoder_multi_cycle_path_constraints/example_a_ip_dut.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: example_a_ip_dut
-- Source Path: example_a_ip/example_a_ip_dut
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
END example_a_ip_dut;


ARCHITECTURE rtl OF example_a_ip_dut IS

  -- Component Declarations
  COMPONENT example_a_ip_src_Subsystem
    PORT( clk                             :   IN    std_logic;
  ...
  FOR ALL : example_a_ip_src_Subsystem
    USE ENTITY work.example_a_ip_src_Subsystem(rtl);
...
BEGIN
  u_example_a_ip_src_Subsystem : example_a_ip_src_Subsystem
    PORT MAP( clk => clk,
              clk_enable => enb,
              reset_x => reset_x,
              In1 => In1,  -- sfix32
