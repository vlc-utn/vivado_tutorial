-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/hdlcoder_multi_cycle_path_constraints/example_a_ip_src_Subsystem.vhd
...
-- -------------------------------------------------------------
-- Model base rate: 7.69231e-09
-- Target subsystem base rate: 7.69231e-09
...
-- -------------------------------------------------------------
-- 
-- Module: example_a_ip_src_Subsystem
...
ENTITY example_a_ip_src_Subsystem IS
...
END example_a_ip_src_Subsystem;


ARCHITECTURE rtl OF example_a_ip_src_Subsystem IS

  -- Component Declarations
  COMPONENT example_a_ip_src_Subsystem_tc
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          clk_enable                      :   IN    std_logic;
  ...
  COMPONENT example_a_ip_src_Dot_Product
  ...
  FOR ALL : example_a_ip_src_Subsystem_tc
    USE ENTITY work.example_a_ip_src_Subsystem_tc(rtl);

  FOR ALL : example_a_ip_src_Dot_Product
    USE ENTITY work.example_a_ip_src_Dot_Product(rtl);

  -- Signals
  SIGNAL enb                              : std_logic;
  SIGNAL enb_1_1_1                        : std_logic;
  SIGNAL enb_65_1_0                       : std_logic;
...
BEGIN
  u_Subsystem_tc : example_a_ip_src_Subsystem_tc
    PORT MAP( clk => clk,
              reset_x => reset_x,
              clk_enable => clk_enable,
              enb_65_1_0 => enb_65_1_0,
              enb => enb,
              enb_1_1_1 => enb_1_1_1
              );

  u_Dot_Product : example_a_ip_src_Dot_Product
