-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/hdlcoder_multi_cycle_path_constraints/example_a_ip.vhd
-- Created: 2024-09-14 13:54:16
-- 
...
ARCHITECTURE rtl OF example_a_ip IS

  -- Component Declarations
  COMPONENT example_a_ip_reset_sync
  ...
  FOR ALL : example_a_ip_reset_sync
    USE ENTITY work.example_a_ip_reset_sync(rtl);

  FOR ALL : example_a_ip_dut
    USE ENTITY work.example_a_ip_dut(rtl);
...
BEGIN
  u_example_a_ip_reset_sync_inst : example_a_ip_reset_sync
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset_in => reset_cm,  -- ufix1
              reset_out => reset_x
              );

  u_example_a_ip_dut_inst : example_a_ip_dut
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset_x => reset_x,
