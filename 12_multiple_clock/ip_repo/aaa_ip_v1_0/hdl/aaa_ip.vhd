-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLMultipleClock/aaa_ip.vhd
...
ARCHITECTURE rtl OF aaa_ip IS

  -- Component Declarations
  COMPONENT aaa_ip_reset_sync
  ...
  FOR ALL : aaa_ip_reset_sync
    USE ENTITY work.aaa_ip_reset_sync(rtl);

  FOR ALL : aaa_ip_dut
    USE ENTITY work.aaa_ip_dut(rtl);
...
BEGIN
  u_aaa_ip_reset_sync_inst : aaa_ip_reset_sync
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset_in => reset_cm,  -- ufix1
              reset_out => reset_x
              );

  u_aaa_ip_dut_inst : aaa_ip_dut
    PORT MAP( clk => IPCORE_CLK,  -- ufix1
              reset_x => reset_x,
