-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLMultipleClock/ccc_ip_dut.vhd
...
ARCHITECTURE rtl OF ccc_ip_dut IS

  -- Component Declarations
  COMPONENT ccc_ip_src_multiple_clock
    PORT( clk                             :   IN    std_logic;
  ...
  FOR ALL : ccc_ip_src_multiple_clock
    USE ENTITY work.ccc_ip_src_multiple_clock(rtl);
...
BEGIN
  u_ccc_ip_src_multiple_clock : ccc_ip_src_multiple_clock
    PORT MAP( clk => clk,
              clk_enable => enb,
              reset_x => reset_x,
