-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj/hdlsrc/HDLMultipleClock/multiple_clock_ip_src_multiple_clock.vhd
-- Created: 2024-08-26 00:46:34
-- 
...
-- -------------------------------------------------------------
-- 
-- Module: multiple_clock_ip_src_multiple_clock
...
ENTITY multiple_clock_ip_src_multiple_clock IS
...
END multiple_clock_ip_src_multiple_clock;


ARCHITECTURE rtl OF multiple_clock_ip_src_multiple_clock IS

  -- Component Declarations
  COMPONENT multiple_clock_ip_src_multiple_clock_tc
    PORT( clk                             :   IN    std_logic;
          reset_x                         :   IN    std_logic;
          clk_enable                      :   IN    std_logic;
          enb                             :   OUT   std_logic;
  ...
  FOR ALL : multiple_clock_ip_src_multiple_clock_tc
    USE ENTITY work.multiple_clock_ip_src_multiple_clock_tc(rtl);
...
BEGIN
  u_multiple_clock_tc : multiple_clock_ip_src_multiple_clock_tc
    PORT MAP( clk => clk,
              reset_x => reset_x,
