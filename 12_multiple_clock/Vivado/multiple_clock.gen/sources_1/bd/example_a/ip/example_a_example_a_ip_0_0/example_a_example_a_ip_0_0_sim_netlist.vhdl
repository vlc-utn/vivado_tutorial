...
-- Date        : Sat Sep 14 14:06:10 2024
-- Host        : cotti-machine running 64-bit Ubuntu 22.04.3 LTS
-- Command     : write_vhdl -force -mode funcsim
--               /home/cotti/Desktop/Proyecto_final/vlc_utn/vivado_tutorial/12_multiple_clock/Vivado/multiple_clock.gen/sources_1/bd/example_a/ip/example_a_example_a_ip_0_0/example_a_example_a_ip_0_0_sim_netlist.vhdl
-- Design      : example_a_example_a_ip_0_0
...
entity example_a_example_a_ip_0_0_example_a_ip_reset_sync is
  port (
  ...
  attribute ORIG_REF_NAME of example_a_example_a_ip_0_0_example_a_ip_reset_sync : entity is "example_a_ip_reset_sync";
end example_a_example_a_ip_0_0_example_a_ip_reset_sync;

architecture STRUCTURE of example_a_example_a_ip_0_0_example_a_ip_reset_sync is
  signal reset_in : STD_LOGIC;
  signal reset_out_i_1_n_0 : STD_LOGIC;
  signal reset_pipe : STD_LOGIC;
  signal \^reset_x\ : STD_LOGIC;
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of reset_out_i_1 : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of reset_pipe_i_1 : label is "soft_lutpair3";
begin
  reset_x <= \^reset_x\;
\count65[6]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity example_a_example_a_ip_0_0_example_a_ip_src_Dot_Product is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of example_a_example_a_ip_0_0_example_a_ip_src_Dot_Product : entity is "example_a_ip_src_Dot_Product";
end example_a_example_a_ip_0_0_example_a_ip_src_Dot_Product;

architecture STRUCTURE of example_a_example_a_ip_0_0_example_a_ip_src_Dot_Product is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity example_a_example_a_ip_0_0_example_a_ip_src_Subsystem_tc is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of example_a_example_a_ip_0_0_example_a_ip_src_Subsystem_tc : entity is "example_a_ip_src_Subsystem_tc";
end example_a_example_a_ip_0_0_example_a_ip_src_Subsystem_tc;

architecture STRUCTURE of example_a_example_a_ip_0_0_example_a_ip_src_Subsystem_tc is
  signal \^q\ : STD_LOGIC_VECTOR ( 0 to 0 );
  signal \count65[0]_i_1_n_0\ : STD_LOGIC;
  signal \count65_reg_n_0_[0]\ : STD_LOGIC;
  signal \count65_reg_n_0_[1]\ : STD_LOGIC;
  signal \count65_reg_n_0_[2]\ : STD_LOGIC;
  signal \count65_reg_n_0_[3]\ : STD_LOGIC;
  signal \count65_reg_n_0_[4]\ : STD_LOGIC;
  signal \count65_reg_n_0_[5]\ : STD_LOGIC;
  signal p_1_in : STD_LOGIC_VECTOR ( 6 downto 1 );
  signal phase_0_i_1_n_0 : STD_LOGIC;
  signal phase_0_i_2_n_0 : STD_LOGIC;
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \count65[0]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \count65[2]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \count65[3]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \count65[4]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of phase_0_i_1 : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of phase_0_i_2 : label is "soft_lutpair2";
begin
  Q(0) <= \^q\(0);
\count65[0]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"F1"
    )
        port map (
      I0 => \^q\(0),
      I1 => \count65_reg_n_0_[0]\,
      I2 => reset_x,
      O => \count65[0]_i_1_n_0\
    );
\count65[1]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
      I0 => \count65_reg_n_0_[0]\,
      I1 => \count65_reg_n_0_[1]\,
      O => p_1_in(1)
    );
\count65[2]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"78"
    )
        port map (
      I0 => \count65_reg_n_0_[0]\,
      I1 => \count65_reg_n_0_[1]\,
      I2 => \count65_reg_n_0_[2]\,
      O => p_1_in(2)
    );
\count65[3]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"7F80"
    )
        port map (
      I0 => \count65_reg_n_0_[1]\,
      I1 => \count65_reg_n_0_[0]\,
      I2 => \count65_reg_n_0_[2]\,
      I3 => \count65_reg_n_0_[3]\,
      O => p_1_in(3)
    );
\count65[4]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"7FFF8000"
    )
        port map (
      I0 => \count65_reg_n_0_[2]\,
      I1 => \count65_reg_n_0_[0]\,
      I2 => \count65_reg_n_0_[1]\,
      I3 => \count65_reg_n_0_[3]\,
      I4 => \count65_reg_n_0_[4]\,
      O => p_1_in(4)
    );
\count65[5]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"7FFFFFFF80000000"
    )
        port map (
      I0 => \count65_reg_n_0_[3]\,
      I1 => \count65_reg_n_0_[1]\,
      I2 => \count65_reg_n_0_[0]\,
      I3 => \count65_reg_n_0_[2]\,
      I4 => \count65_reg_n_0_[4]\,
      I5 => \count65_reg_n_0_[5]\,
      O => p_1_in(5)
    );
\count65[6]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"8000000000000000"
    )
        port map (
      I0 => \count65_reg_n_0_[4]\,
      I1 => \count65_reg_n_0_[2]\,
      I2 => \count65_reg_n_0_[0]\,
      I3 => \count65_reg_n_0_[1]\,
      I4 => \count65_reg_n_0_[3]\,
      I5 => \count65_reg_n_0_[5]\,
      O => p_1_in(6)
    );
\count65_reg[0]\: unisim.vcomponents.FDRE
     port map (
      C => IPCORE_CLK,
      CE => '1',
      D => \count65[0]_i_1_n_0\,
      Q => \count65_reg_n_0_[0]\,
      R => '0'
    );
\count65_reg[1]\: unisim.vcomponents.FDRE
     port map (
      C => IPCORE_CLK,
      CE => '1',
      D => p_1_in(1),
      Q => \count65_reg_n_0_[1]\,
      R => SR(0)
    );
\count65_reg[2]\: unisim.vcomponents.FDRE
     port map (
      C => IPCORE_CLK,
      CE => '1',
      D => p_1_in(2),
      Q => \count65_reg_n_0_[2]\,
      R => SR(0)
    );
\count65_reg[3]\: unisim.vcomponents.FDRE
     port map (
      C => IPCORE_CLK,
      CE => '1',
      D => p_1_in(3),
      Q => \count65_reg_n_0_[3]\,
      R => SR(0)
    );
\count65_reg[4]\: unisim.vcomponents.FDRE
     port map (
      C => IPCORE_CLK,
      CE => '1',
      D => p_1_in(4),
      Q => \count65_reg_n_0_[4]\,
      R => SR(0)
    );
\count65_reg[5]\: unisim.vcomponents.FDRE
     port map (
      C => IPCORE_CLK,
      CE => '1',
      D => p_1_in(5),
      Q => \count65_reg_n_0_[5]\,
      R => SR(0)
    );
\count65_reg[6]\: unisim.vcomponents.FDRE
     port map (
      C => IPCORE_CLK,
      CE => '1',
      D => p_1_in(6),
...
phase_0_i_1: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00000004"
    )
        port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity example_a_example_a_ip_0_0_example_a_ip_src_Subsystem is
  port (
    Q : out STD_LOGIC_VECTOR ( 0 to 0 );
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of example_a_example_a_ip_0_0_example_a_ip_src_Subsystem : entity is "example_a_ip_src_Subsystem";
end example_a_example_a_ip_0_0_example_a_ip_src_Subsystem;

architecture STRUCTURE of example_a_example_a_ip_0_0_example_a_ip_src_Subsystem is
...
u_Dot_Product: entity work.example_a_example_a_ip_0_0_example_a_ip_src_Dot_Product
     port map (
...
u_Subsystem_tc: entity work.example_a_example_a_ip_0_0_example_a_ip_src_Subsystem_tc
     port map (
      E(0) => phase_0,
      IPCORE_CLK => IPCORE_CLK,
      Q(0) => Q(0),
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity example_a_example_a_ip_0_0_example_a_ip_dut is
  port (
    Q : out STD_LOGIC_VECTOR ( 0 to 0 );
    Out1 : out STD_LOGIC_VECTOR ( 63 downto 0 );
    IPCORE_CLK : in STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of example_a_example_a_ip_0_0_example_a_ip_dut : entity is "example_a_ip_dut";
end example_a_example_a_ip_0_0_example_a_ip_dut;

architecture STRUCTURE of example_a_example_a_ip_0_0_example_a_ip_dut is
begin
u_example_a_ip_src_Subsystem: entity work.example_a_example_a_ip_0_0_example_a_ip_src_Subsystem
     port map (
      IPCORE_CLK => IPCORE_CLK,
      In1(31 downto 0) => In1(31 downto 0),
      In2(287 downto 0) => In2(287 downto 0),
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity example_a_example_a_ip_0_0_example_a_ip is
  port (
    Out1 : out STD_LOGIC_VECTOR ( 63 downto 0 );
    IPCORE_RESETN : in STD_LOGIC;
    IPCORE_CLK : in STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of example_a_example_a_ip_0_0_example_a_ip : entity is "example_a_ip";
end example_a_example_a_ip_0_0_example_a_ip;

architecture STRUCTURE of example_a_example_a_ip_0_0_example_a_ip is
  signal reset_x : STD_LOGIC;
  signal u_example_a_ip_dut_inst_n_0 : STD_LOGIC;
  signal \u_example_a_ip_src_Subsystem/u_Subsystem_tc/count65\ : STD_LOGIC_VECTOR ( 1 to 1 );
begin
u_example_a_ip_dut_inst: entity work.example_a_example_a_ip_0_0_example_a_ip_dut
     port map (
      IPCORE_CLK => IPCORE_CLK,
      In1(31 downto 0) => In1(31 downto 0),
      In2(287 downto 0) => In2(287 downto 0),
      Out1(63 downto 0) => Out1(63 downto 0),
      Q(0) => u_example_a_ip_dut_inst_n_0,
      SR(0) => \u_example_a_ip_src_Subsystem/u_Subsystem_tc/count65\(1),
      reset_x => reset_x
    );
u_example_a_ip_reset_sync_inst: entity work.example_a_example_a_ip_0_0_example_a_ip_reset_sync
     port map (
      IPCORE_CLK => IPCORE_CLK,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity example_a_example_a_ip_0_0 is
  port (
    IPCORE_CLK : in STD_LOGIC;
    IPCORE_RESETN : in STD_LOGIC;
    In1 : in STD_LOGIC_VECTOR ( 31 downto 0 );
  ...
  attribute NotValidForBitStream of example_a_example_a_ip_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of example_a_example_a_ip_0_0 : entity is "example_a_example_a_ip_0_0,example_a_ip,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of example_a_example_a_ip_0_0 : entity is "yes";
  attribute ip_definition_source : string;
  attribute ip_definition_source of example_a_example_a_ip_0_0 : entity is "package_project";
  attribute x_core_info : string;
  attribute x_core_info of example_a_example_a_ip_0_0 : entity is "example_a_ip,Vivado 2023.2";
end example_a_example_a_ip_0_0;

architecture STRUCTURE of example_a_example_a_ip_0_0 is
...
begin
U0: entity work.example_a_example_a_ip_0_0_example_a_ip
     port map (
      IPCORE_CLK => IPCORE_CLK,
      IPCORE_RESETN => IPCORE_RESETN,
      In1(31 downto 0) => In1(31 downto 0),
